  ...
  return (
    <a
      ...
      className={cn(
        variant === 'rail'
          ? cn(
              'flex items-center gap-2 border-l-2 border-transparent py-1 pl-3 text-sm text-muted-foreground transition-colors hover:text-foreground',
              active && 'border-primary font-medium text-foreground bg-transparent',
            )
          : cn(
          ...
          return (
            <li key={item.id}>
              <a
                ...
                className={cn(
                  'block border-l-2 border-transparent py-1 pl-3 text-sm text-muted-foreground transition-colors hover:text-foreground',
